...
large_area_geom = {
    "type": "Polygon",
    "coordinates": [[[10.931396,47.761484],[10.931396,48.494768],[12.381592,48.494768],[12.381592,47.761484],[10.931396,47.761484]]]
}
...
def test_get_shops_raises_when_area_exceeds_threshold():
    with pytest.raises(AssertionError, match="Please select a smaller area."):
        get_shops(shop_types=["Supermarkt"], area_geom=large_area_geom, sb_kassen_filter=True)
