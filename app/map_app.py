...
st.session_state.shops = sbf.multiselect(app_text[lang]['shops'],
                        #  icon_f.keys(),
                         shops,
                         )
        ...
        mark = folium.Marker(
            ...
            popup=folium.Popup(
                popup_html(
                    ...
                    app_text[lang]['popup_pl'] if review_stat[r['place_id']]['num_review'] != 1 else '',
                    app_text[lang]['popup_verb_tense'] if review_stat[r['place_id']]['num_review'] != 1 else '',
